defmodule Hackathon.Semilla do
  ...
  # NUEVO: Agregar anuncio de bienvenida
  agregar_anuncio_bienvenida()
  IO.puts(" Anuncio de bienvenida agregado")
...
defp agregar_anuncio_bienvenida do
  # Esperar un momento para que el GenServer esté listo
  :timer.sleep(500)

  canal = "general"
  # Mensaje sin caracteres especiales problemáticos
  mensaje = "Bienvenidos a la Hackathon Code4Future 2025! Durante las proximas 48 horas trabajaremos juntos para crear soluciones innovadoras. Recuerden: formar equipos de maximo 6 personas, registrar avances constantemente, consultar con mentores cuando lo necesiten y mantener comunicacion activa. Mucha suerte a todos!"

  case Hackathon.Services.SistemaChat.enviar_mensaje("sistema", mensaje, canal) do
    {:ok, _} ->
      IO.puts(" Mensaje de bienvenida enviado correctamente")
      :ok
    error ->
      IO.puts(" Error al enviar mensaje de bienvenida: #{inspect(error)}")
      :error
  end
end
end
